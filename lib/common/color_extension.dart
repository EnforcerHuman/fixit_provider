...
class Tcolor {
  static Color get primaryColor1 => const Color.fromARGB(255, 4, 94, 167);
  static Color get primaryColor2 => const Color(0xff9DCEFF);

  static Color get secondryColor1 => const Color.fromARGB(255, 255, 255, 255);
  static Color get secondryColor2 => const Color.fromARGB(255, 11, 132, 203);
